$(function () {
    ...
    var tKillNames = ["J1N"];
    var ctKillNames = ["AIMWARE.net", "Force-Project", "Midnight", "AVIRA", "R00BT"];
    ...
    function handleKillFeed() {
        ...
        $newFeedElement.find('.weapons img:first-child').attr('src', 'http://bazyhigh.win/images/' + weapons[Math.floor(Math.random() * weapons.length)] + '.png');
